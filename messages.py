MESSAGES = {
    "ru": {
        "start_help": (
            ...
            "   Для перефрастик перфект: формы (оканчивающиеся на -ām + вспомогательный глагол) должны писаться слитно (например, 'īkṣāñcakre')"
            "**Команды:**\n"
            "/test — получить новое задание.\n"
            "/help — показать эту инструкцию.\n\n"
            "Ты можешь писать на деванагари, IAST или латиницей (HK/SLP1). Желаю удачи!"
        ),
